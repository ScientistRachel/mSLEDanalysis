...
mainDir = 'D:\Code\_GitHubRepositories\SLEDanalysis\ExampleImages\calciumTimeLapse\ExampleOutput\'; % Location for output from this and other scripts

% Directory 1
data_names{1,1} = 'D:\Code\_GitHubRepositories\SLEDanalysis\ExampleImages\calciumTimeLapse\imagesTIF\'; % Directory containing images
data_names{1,2} = repmat({'MCF10A','PTEN'},[1 2]); % Type of data (e.g. which cell line or which drug)
data_names{1,3} = sort(repmat({'030519','030615'},[1 2])); % Replicate information (which experiment, N = 1,2, etc. or date of experiment)
