...
%%%%%%%%% User Inputs
directories = {'D:\Code\_GitHubRepositories\SLEDanalysis\ExampleImages\calciumTimeLapse\imagesOIB\'}; % Folder of .oib files
savedirs = {'D:\Code\_GitHubRepositories\SLEDanalysis\ExampleImages\calciumTimeLapse\imagesTIF\'}; % Location for .tif files
